...
// fetch from APIa
$apiUrl = "https://api.openweathermap.org/data/2.5/weather?units=metric&q=${city}&appid=${apiKey}"; // Replace with the actual API URL
...
$sql = "INSERT INTO data (city, temp, humidity, pressure, wind_speed, datetime) VALUES (?, ?, ?, ?, ?, ?)";
